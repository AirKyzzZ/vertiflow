...
const slides = [
  {
    name: "slide-1",
    shot: "editorial/img-0839.webp",
    position: "50% 40%",
    kicker: "2025 — 2026",
    headline: "UN AN<br>SANS POSTER.",
    sub: "Voilà ce que je faisais.",
  },
  {
    name: "slide-2",
    shot: "editorial/img-6549.webp",
    position: "50% 42%",
    kicker: "DEUX STRUCTURES",
    headline: "J’EN AI MONTÉ<br>DEUX.",
    sub: "VertiFlow, la marque. PKBA, une association de parkour.",
  },
  {
    name: "slide-3",
    shot: "editorial/img-0979.webp",
    position: "50% 36%",
    kicker: "SEPTEMBRE 2025",
    headline: "LE CLUB A<br>UN AN.",
    sub: "Ouvert en septembre 2025. Pas encore de local.",
  },
  {
    name: "slide-4",
