...
const slides = [
  {
    name: "slide-1",
    shot: "editorial/img-0740.webp",
    position: "50% 42%",
    kicker: "COMMENCER",
    headline: "PERSONNE<br>N’ARRIVE EN<br>SACHANT.",
    sub: "Quatre choses à savoir avant ta première séance.",
    size: 100,
  },
  {
    name: "slide-2",
    shot: "editorial/img-1029.webp",
    position: "50% 45%",
    kicker: "COMMENCER",
    headline: "PAS DE<br>MATÉRIEL.",
    sub: "Des vêtements dans lesquels tu bouges, des baskets. C’est tout.",
  },
  {
    name: "slide-3",
    shot: "editorial/img-0993.webp",
    position: "50% 40%",
    kicker: "COMMENCER",
    headline: "TOUT LE MONDE<br>SERA MEILLEUR<br>QUE TOI.",
    sub: "Au début, sans doute. Eux aussi ont commencé en ratant.",
    size: 82,
  },
  {
    name: "slide-4",
    ...
    headline: "LA PREMIÈRE<br>SÉANCE NE<br>COÛTE RIEN.",
    sub: "Les créneaux du club sont sur pkba.vertiflow.fr.",
    size: 98,
  },
];
