...
import { HeroLabTextAnimateHeadline } from '@/components/motion/hero-lab-text-animate-headline'
...
export const metadata: Metadata = {
  title: 'Hero Lab D — Magic UI Text Animate',
  description: 'Prototype: the headline reveal built on Magic UI TextAnimate (shadcn convention), word and character blur-in.',
}

export function HeroLabD() {
