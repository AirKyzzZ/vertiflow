...
import { HeroLabSplitHeadline } from '@/components/motion/hero-lab-split-headline'
...
export const metadata: Metadata = {
  title: 'Hero Lab E — GSAP SplitText',
  description: 'Prototype: a per-word masked reveal built with GSAP SplitText, masks generated by SplitText itself.',
}

export function HeroLabE() {
